...
export const MOCK_GROWTH_DATA: GrowthData[] = [
  ...
  { month: 2, height: 58, weight: 5.6 },
  { month: 3, height: 61, weight: 6.4 },
  { month: 4, height: 63, weight: 7.0 },
  { month: 5, height: 66, weight: 7.5 },
  { month: 6, height: 68, weight: 8.0 },
  { month: 9, height: 72, weight: 9.2 },
  { month: 12, height: 76, weight: 10.5 },
];