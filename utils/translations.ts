...
export const translations = {
  ...
  nationality_label: { en: "Nationality", mm: "နိုင်ငံသား" },
  father_name: { en: "Father's Name", mm: "ဖခင်အမည်" },
  mother_name: { en: "Mother's Name", mm: "မိခင်အမည်" },
  eye_color: { en: "Eye Color", mm: "မျက်လုံးအရောင်" },
  hair_color: { en: "Hair Color", mm: "ဆံပင်အရောင်" },
  special_notes: { en: "Special Notes / Allergies", mm: "အထူးမှတ်စု / ဓာတ်မတည့်မှုများ" },
  ...
  enter_passcode: { en: "Enter PIN (4-digits)", mm: "လျှို့ဝှက်နံပါတ် (၄ လုံး) ရိုက်ပါ" },
  create_passcode: { en: "Create PIN (4-digits)", mm: "လျှို့ဝှက်နံပါတ် (၄ လုံး) သတ်မှတ်ပါ" },
